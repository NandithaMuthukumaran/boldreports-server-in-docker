...
|`BOLD_SERVICES_LICENSE_TOKEN` |              | Yes         | Specify the value of the online license token. This variable is used to validate the license. You can find the license token inside your online unlock key. <br /> For example: "license_token": "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" |
|`BOLD_SERVICES_OFFLINE_LICENSE_TOKEN`|       | Yes         | Specifies the value of the offline license token, This variable is used to validate the license. You can find the offline license toekn inside your offline unlock key. <br /> For example: "offline_license_token": "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" |
